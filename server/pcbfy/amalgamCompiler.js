...
function getPhysicalHTML() {
  ...
  // For each CSS File get CSS variables and Physical Components
...
function parseCSS(cssFilePath) {
  ...
  for (var i=0; i< totalrules; i++) {
    ...
    if (isPhysical == true) {
      ...
      physicalComp[selector] = "<"+physicalComponentName+oldAttributes+physicalAttributes+"></"+physicalComponentName+">";
